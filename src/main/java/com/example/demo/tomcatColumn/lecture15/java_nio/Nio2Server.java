...
import com.example.demo.tomcatColumn.lecture15.java_nio.pool.MyThreadFactoryBuilder;
...
public class Nio2Server {
    ...
    void listen() throws IOException {
        ...
        AsynchronousChannelGroup acg = AsynchronousChannelGroup.withCachedThreadPool(pool, 1);
